...
export const INITIAL_AUDIT_LOGS = [
  {
    id: 'AUD-20260813-0945',
    timestamp: '2026-08-13 14:31:02',
    date: '2026-08-13',
    time: '14:31:02',
    initiator: 'system_process',
    initiatorRole: 'System Automated Sentinel',
    module: 'AVDS Monitor',
    activity: 'Radar sensor signal degraded due to heavy localized rain telemetry',
    location: 'Putra Mahkota–Southville Interchange',
    locationId: 'pms',
    equipmentId: 'AVDS-KM7.5NB',
    result: 'Warning',
    securityHash: 'sha256:8f2a11b90d23c4a17890e'
  },
  {
    id: 'AUD-20260813-0942',
    timestamp: '2026-08-13 14:24:00',
    date: '2026-08-13',
    time: '14:24:00',
    initiator: 'admin (Operator Ahmad)',
    initiatorRole: 'TMC Lead Controller',
    module: 'Control Panel',
    activity: 'Manual intervention "PAUSE" event initiated for emergency clearance',
    location: 'Putra Mahkota–Southville Interchange',
    locationId: 'pms',
    equipmentId: 'CTRL-PMS-01',
    result: 'Paused',
    securityHash: 'sha256:4a9c88210fe155d0124b8'
  },
  {
    id: 'AUD-20260813-0938',
    timestamp: '2026-08-13 13:58:41',
    date: '2026-08-13',
    time: '13:58:41',
    initiator: 'system_process',
    initiatorRole: 'Hardware Health Daemon',
    module: 'CCTV System',
    activity: 'CCTV camera stream offline & ping failure detected',
    location: 'Sungai Bakap Layby–Jawi Interchange',
    locationId: 'sbj',
    equipmentId: 'CCTV-KM46.2NB',
    result: 'Fault',
    securityHash: 'sha256:b34e9102c77a882d911c4'
  },
  {
    id: 'AUD-20260813-0930',
    timestamp: '2026-08-13 13:45:10',
    date: '2026-08-13',
    time: '13:45:10',
    initiator: 'operator_sarah',
    initiatorRole: 'Senior Traffic Operator',
    module: 'VMS Controller',
    activity: 'Updated VMS sign display to "SMARTLANE BERMULA / MULA GUNAKAN LORONG KECEMASAN"',
    location: 'Putra Mahkota–Southville Interchange',
    locationId: 'pms',
    equipmentId: 'VMS-KM3.5NB',
    result: 'Success',
    securityHash: 'sha256:11a0984de29e37bc90231'
  },
  {
    id: 'AUD-20260813-0922',
    timestamp: '2026-08-13 12:10:15',
    date: '2026-08-13',
    time: '12:10:15',
    initiator: 'admin (Operator Ahmad)',
    initiatorRole: 'TMC Lead Controller',
    module: 'LCS Matrix',
    activity: 'Bulk state updated to MATCH_LANE (Gantry overhead indicators sync)',
    location: 'Putra Mahkota–Southville Interchange',
    locationId: 'pms',
    equipmentId: 'LCS-KM3.8NB',
    result: 'Success',
    securityHash: 'sha256:7e990b12a88f432e109aa'
  },
  {
    id: 'AUD-20260813-0915',
    timestamp: '2026-08-13 11:30:00',
    date: '2026-08-13',
    time: '11:30:00',
    initiator: 'scheduler_daemon',
    initiatorRole: 'Automated Job Runner',
    module: 'Schedule Editor',
    activity: 'Executed scheduled rule: "Peak Hours — Evening Northbound" armed',
    location: 'Putra Mahkota–Southville Interchange',
    locationId: 'pms',
    equipmentId: 'SCHED-JOB-882',
    result: 'Success',
    securityHash: 'sha256:3901bc09a1e882200119c'
  },
  {
    id: 'AUD-20260813-0901',
    ...
    initiatorRole: 'Senior Traffic Operator',
    module: 'CCTV System',
    activity: 'Manual CCTV PTZ preset adjusted and snapshot captured for inspection',
    location: 'Dato\' Onn–Pasir Gudang Interchange',
    locationId: 'dopg',
    equipmentId: 'CCTV-KM22.9NB',
    result: 'Success',
    securityHash: 'sha256:99c1827409bcef11762e1'
  },
  {
    id: 'AUD-20260813-0850',
    timestamp: '2026-08-13 09:00:00',
    date: '2026-08-13',
    time: '09:00:00',
    initiator: 'system_process',
    initiatorRole: 'Automated Integrity Watchdog',
    module: 'System Core',
    activity: 'Daily cryptographic audit trail verification completed — 0 tampered entries',
    location: 'Global / System-Wide',
    locationId: 'global',
    equipmentId: 'SYS-AUDIT-CORE',
    result: 'Success',
    securityHash: 'sha256:00ab9912ce491029341ff'
  },
  {
    id: 'AUD-20260812-0812',
    ...
    initiatorRole: 'Automated Job Runner',
    module: 'Schedule Editor',
    activity: 'Schedule started: Evening Peak Hour Activation',
    location: 'Putra Mahkota–Southville Interchange',
    locationId: 'pms',
    equipmentId: 'SCHED-JOB-881',
    result: 'Success',
    securityHash: 'sha256:4421aa8920199182371b5'
  },
  {
    id: 'AUD-20260812-0740',
    timestamp: '2026-08-12 14:15:30',
    date: '2026-08-12',
    time: '14:15:30',
    initiator: 'admin (Operator Ahmad)',
    initiatorRole: 'TMC Lead Controller',
    module: 'Schedule Editor',
    activity: 'Modified weekend schedule parameters for Bertam–Sg. Dua Plaza',
    location: 'Bertam–Sg. Dua Plaza',
    locationId: 'bsd',
    equipmentId: 'SCHED-MOD-104',
    result: 'Success',
    securityHash: 'sha256:663019ab72810a99182cd'
  }
];
